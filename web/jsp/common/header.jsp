        ...
        <div class="navbar-content">
            <ul class="nav navbar-top-links">
                ...
                <li class="tgl-menu-btn">
                    <a class="mainnav-toggle" href="../jsp/index.jsp">
            ...
            <ul class="nav navbar-top-links">
                ...
                <li class="mega-dropdown">
                    <a href="../jsp/index.jsp" class="mega-dropdown-toggle">
                        ...
                        <div class="row">
                            <div class="col-sm-4 col-md-3">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href="../jsp/index.jsp">Profile</a></li>
                                    <li><a href="../jsp/index.jsp">Search Result</a></li>
                                    <li><a href="../jsp/index.jsp">FAQ</a></li>
                                    <li><a href="../jsp/index.jsp">Sreen Lock</a></li>
                                    <li><a href="../jsp/index.jsp">Maintenance</a></li>
                                    <li><a href="../jsp/index.jsp">Invoice</a></li>
                                    <li><a href="../jsp/index.jsp" class="disabled">Disabled</a></li>                                        </ul>
                            ...
                            <div class="col-sm-4 col-md-3">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href="../jsp/index.jsp"><span class="pull-right label label-danger">Hot</span>Indox</a></li>
                                    <li><a href="../jsp/index.jsp">Read Message</a></li>
                                    <li><a href="../jsp/index.jsp">Compose</a></li>
                                    <li><a href="../jsp/index.jsp">Template</a></li>
                                </ul>
                            ...
                            <div class="col-sm-4 col-md-3">
                                ...
                                <ul class="list-unstyled">
                                    <li>
                                        <a href="../jsp/index.jsp" class="media mar-btm">
                            ...
                            <div class="col-sm-12 col-md-3">
                                ...
                                <a href="../jsp/index.jsp" class="btn btn-block btn-primary">Browse Gallery</a>
                            </div>
                        </div>
                    </div>
                </li>
                ...
                <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                <li class="dropdown">
                    <a href="../jsp/index.jsp" data-toggle="dropdown" class="dropdown-toggle">
                    ...
                    <div class="dropdown-menu dropdown-menu-md dropdown-menu-right">
                        <div class="nano scrollable">
                            <div class="nano-content">
                                <ul class="head-list">
                                    <li>
                                        <a href="../jsp/index.jsp" class="media add-tooltip" data-title="Used space : 95%" data-container="body" data-placement="bottom">
                                            <div class="media-left">
                                    ...
                                    <li>
                                        <a class="media" href="../jsp/index.jsp">
                                            <div class="media-left">
                        ...
                        <div class="pad-all bord-top">
                            <a href="../jsp/index.jsp" class="btn-link text-main box-block">
                ...
                <li id="dropdown-user" class="dropdown">
                    <a href="../jsp/index.jsp" data-toggle="dropdown" class="dropdown-toggle text-right">
                    ...
                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right panel-default">
                        <ul class="head-list">
                            <li>
                                <a href="../jsp/index.jsp"><i class="demo-pli-male icon-lg icon-fw"></i> Profile</a>
                            </li>
                            <li>
                                <a href="../jsp/index.jsp"><span class="badge badge-danger pull-right">9</span><i class="demo-pli-mail icon-lg icon-fw"></i> Messages</a>
                            </li>
                            <li>
                                <a href="../jsp/index.jsp"><span class="label label-success pull-right">New</span><i class="demo-pli-gear icon-lg icon-fw"></i> Settings</a>
                            </li>
                            <li>
                                <a href="../jsp/index.jsp"><i class="demo-pli-computer-secure icon-lg icon-fw"></i> Lock screen</a>
                            </li>
                            <li>
                ...
                <li>
                    <a href="../jsp/index.jsp" class="aside-toggle">
