                    ...
                    <ul id="mainnav-menu" class="list-group">
                        ...
                        <%--<li class="active-sub">
                            <a href="../jsp/index.jsp">
                                ...
                                <span class="menu-title">系统管理首页</span>
                                <i class="arrow"></i>
                            </a>
                            <!--Submenu-->
                            <ul class="collapse in" id="liklist">
                                <li><a href="../jsp/sysuser.jsp">用户管理</a></li>
                        ...
                        <%-- <!--Menu list item-->
                         ...
                         <li>
                             ...
                             <!--Submenu-->
                             <ul class="collapse">
                                 <li><a href="../jsp/index.jsp">Second Level Item</a></li>
                                 <li><a href="../jsp/index.jsp">Second Level Item</a></li>
                                 <li><a href="../jsp/index.jsp">Second Level Item</a></li>
                                 <li class="list-divider"></li>
                                 <li>
                                     <a href="../jsp/index.jsp">Third Level<i class="arrow"></i></a>

                                     <!--Submenu-->
                                     <ul class="collapse">
                                         <li><a href="../jsp/index.jsp">Third Level Item</a></li>
                                         <li><a href="../jsp/index.jsp">Third Level Item</a></li>
                                         <li><a href="../jsp/index.jsp">Third Level Item</a></li>
                                         <li><a href="../jsp/index.jsp">Third Level Item</a></li>
                                     </ul>
    ...
    $(function () {
        ...
        for (var i = 0; i < data.length; i++) {
            if (data[i].reopjigouid == 0) {
                ...
                $("#mainnav-menu").append(/*'<li class="active-sub" id="' + data[i].reid + '">\n' +
                        '<i class="demo-pli-home"></i>'+
                    '<a href=' + resource[i].relink + '>\n' +
                    '<span class="menu-title">' + data[i].resourcename + '</span>\n' +
                    '<i class="arrow"></i>\n' +
                    '</a>'*/
                    '<li class="active-sub" id="' + data[i].reid + '">\n' +
                    '\t\t\t\t\t\t                <a href=' + resource[i].relink + '>\n' +
                    '\t\t\t\t\t\t                    <i class="demo-pli-home"></i>\n' +
                    '\t\t\t\t\t\t                    <span class="menu-title">' + data[i].resourcename + '</span>\n' +
                    '\t\t\t\t\t\t\t\t\t\t\t<i class="arrow"></i>\n' +
