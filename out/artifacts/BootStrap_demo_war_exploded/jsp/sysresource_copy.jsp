        ...
        $(function () {
            window.operateEvents = {
                ...
                'click .xiugai': function (e, value, row, index) {
                    $("#xiugai input[name=reid]").val(row.reid);
                    $("#xiugai input[name=resourcename]").val(row.resourcename);
                    $("#xiugai input[name=relink]").val(row.relink);
                    $("#xiugai input[name=rebianhao]").val(row.rebianhao);
                    $("#xiugai input[name=rejigouid]").val(row.rejigouid);
                    $("#xiugai input[name=reopjigouid]").val(row.reopjigouid);
                    $.ajax({
                        url:"../system/updatesysresourcemess",
